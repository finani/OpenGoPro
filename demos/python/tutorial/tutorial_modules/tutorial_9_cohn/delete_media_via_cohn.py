...
async def main(ip_address: str, username: str, password: str, certificate: Path) -> None:
    url = f"https://{ip_address}" + "/gopro/media/delete/file" + "?path=100GOPRO/GX060003.MP4"
...
if __name__ == "__main__":
    ...
    try:
        asyncio.run(main("192.168.0.109", "gopro", "fn7INOh7rdVi", "/home/ihwee/temp/OpenGoPro/demos/python/tutorial/tutorial_modules/tutorial_9_cohn/cohn.crt"))
